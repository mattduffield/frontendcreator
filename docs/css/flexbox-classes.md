...
The following is a table of all the Flexbox related classes that are currently provided in the autocomplete input element. Please refer to CSS documentation on what each of the CSS properties do:
